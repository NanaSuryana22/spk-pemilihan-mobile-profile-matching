@extends('layout.master') @section('title', "Tambah Data Kriteria")
@section('kriteria', 'active') @section('content')
                                ...
                                <form
                                    ...
                                    <div class="item form-group">
                                        <label
                                            ...
                                            for="Jenis Kriteria">Jenis Kriteria
                                    ...
                                    <div class="item form-group">
                                        <label
                                            class="col-form-label col-md-3 col-sm-3 label-align"
                                            for="nama_sub_kriteria">Nama Sub Kriteria<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input
                                                type="text"
                                            ...
                                            @if($errors->has('nama_sub_kriteria'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{$errors->first('nama_sub_kriteria') }}</strong>
                                            </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="nilai">Nilai Sub Kriteria<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input
                                                type="number"
