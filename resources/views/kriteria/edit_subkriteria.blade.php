                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
															<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('updatesubkriteria', $sub_kriteria->id) }} ">
																{{ csrf_field() }} {{method_field('PUT')}}
																<div class="item form-group">
																	<label class="col-form-label col-md-3 col-sm-3 label-align" for="kriteria">Nama Kriteria<span class="required">*</span>
																	</label>
																	<div class="col-md-6 col-sm-6 ">
																		<input type="hidden" required="required" class="form-control @error('kriteria_id') is-invalid @enderror" name="kriteria_id" value="{{ $sub_kriteria->kriteria_id }}">
																		<input type="text" required="required" class="form-control @error('kriteria_id') is-invalid @enderror" name="kriteria_id" value="{{ $sub_kriteria->kriteria->nama }}" disabled>
