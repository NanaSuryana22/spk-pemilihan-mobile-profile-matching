						...
						@foreach($mobil as $m)
							<tr>
								...
								@endforeach
									...
									?>
									<td class="th-font" data-title="NCF">{!! floatval($nilai_cf); !!}</td>
									<td class="th-font" data-title="NSF">{!! floatval($total_sf/$jml_sf); !!}</td>
									<td class="th-font" data-title="Nilai">{!! $na; !!}</td>
							</tr>
						@endforeach
							<tr>
